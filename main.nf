...
summary['Mash kmer size']                                   = params.mash_kmer_size
summary['Mash hash amount']                                 = params.mash_hash_amount
...
summary['Skip phage-named assemblies from mapping']         = params.skip_phage_assemblies 
